/*
  Fox & Frame Studio
  Demo viewer (modal + embedded)

  Usage:
  - Modal trigger button:
      <button class="btn ..." data-ff-demo-open data-demo-key="trades">Preview demo</button>
  - Embedded viewer container (demo.html):
      <div data-ff-demo-embed></div>
*/

(function () {
  "use strict";

  const demos = window.FF_DEMOS || {};
  ...
  function initModal() {
    ...
    // Clear iframes when the modal closes (stops audio, reduces CPU)
    ...
    document.querySelectorAll("[data-ff-demo-open]").forEach((btn) => {
      btn.addEventListener("click", () => {
        ...
        // Default to desktop view each time
